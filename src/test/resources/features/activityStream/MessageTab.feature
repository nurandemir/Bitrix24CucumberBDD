...
#7. User should be able to click on Visual Editor and see the editor text-bar displays on top of
#     the message box.
#8. User should be able to click on the Topic icon to see the Message Topic text box displays
