#7. As a user, I should be able to send announcement from Announcement subheading
...
#7. User should be able to click on Visual Editor and see the editor text-bar
#    displays on top of the message box.
#8. User should be able to click on the Topic icon to see the announcement Topic text box
#    displays on top of the message box.
...
@announcement_tab
Feature: As a user, I should be able to send announcement from Announcement subheading from "More" under
  Activity Stream.
  ...
  Scenario: Click on upload files icon to upload files and pictures from local disks,
    ...
    Then user clicks "Announcement" submodule
    Then user clicks "Announcement" upload file
